...
void test_adc_convert_temperature_edge_max(void){
    ...
    temp_int = (int16_t)adc_convert_batt_temp(moc_adc_read);
    TEST_ASSERT_EQUAL((int16_t)15005, temp_int);
}
...
void test_adc_convert_temperature_edge_min(void){
    ...
    temp_int = (int16_t)adc_convert_batt_temp(moc_adc_read);
    TEST_ASSERT_EQUAL((int16_t)-5495, temp_int);
}
...
// void test_adc_convert_current_positive(void) {
//     // uint16_t adc_value = 0;
//     uint16_t current = 0;
//     // moc_adc_set(4095);
//     // adc_value = moc_adc_read((uint8_t)0xff);
...
//     UNITY_BEGIN();
//     RUN_TEST(test_adc_convert_current_positive);
//     HAL_Delay(500);
//     UNITY_END();
